    ...
    <footer className="py-16 md:py-24 border-t border-border">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            <a href="/" className="inline-block mb-6">
              <span className="text-foreground text-xl font-medium tracking-tight">Алёна Цукур</span>
            </a>
            <p className="text-muted-foreground leading-relaxed max-w-sm">
              Дизайн интерьера полного цикла — от консультации и подбора цвета до инженерной документации для строителей.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row md:items-center justify-between gap-4 text-sm text-muted-foreground">
          <p>© 2026 Алёна Цукур. Все права защищены.</p>
